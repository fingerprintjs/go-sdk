...
func ExampleClient_SearchEvents() {
	...
	visitorID := "visitorID_example"                           // string | Unique [visitor identifier](https://docs.fingerprint.com/reference/js-agent-get-function#visitorid) issued by Fingerprint Identification and all active Smart Signals. Filter for events matching this `visitor_id`.  (optional)
...
func ExampleClient_UpdateEvent() {
	...
	eventID := "eventID_example" // string | The unique event [identifier](https://docs.fingerprint.com/reference/js-agent-get-function#event_id).
