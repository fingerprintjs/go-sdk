...
func (v *SearchEventsSource) UnmarshalJSON(src []byte) error {
	...
	enumTypeValue := SearchEventsSource(value)
	for _, existing := range AllowedSearchEventsSourceEnumValues {
	...
	return fmt.Errorf("%+v is not a valid SearchEventsSource", value)
}
