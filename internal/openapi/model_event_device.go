...
// checks if the EventDevice type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EventDevice{}

// EventDevice Contains results from Fingerprint Identification and Smart Signals derived from client-side device telemetry. Consult the [Smart Signals reference](https://docs.fingerprint.com/docs/smart-signals-reference) for more details.
...
type _EventDevice EventDevice

func (o EventDevice) MarshalJSON() ([]byte, error) {
...
func (o EventDevice) ToMap() (map[string]interface{}, error) {
...
func (o *EventDevice) UnmarshalJSON(data []byte) (err error) {
	...
	varEventDevice := _EventDevice{}

	err = json.Unmarshal(data, &varEventDevice)

	if err != nil {
		return err
	}

	*o = EventDevice(varEventDevice)
