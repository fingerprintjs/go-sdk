...
type NullableIPInfoV4 struct {
	value *IPInfoV4
	isSet bool
}

func (v NullableIPInfoV4) Get() *IPInfoV4 {
	return v.value
}

func (v *NullableIPInfoV4) Set(val *IPInfoV4) {
	v.value = val
	v.isSet = true
}

func (v NullableIPInfoV4) IsSet() bool {
	return v.isSet
}

func (v *NullableIPInfoV4) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIPInfoV4(val *IPInfoV4) *NullableIPInfoV4 {
	return &NullableIPInfoV4{value: val, isSet: true}
}

func (v NullableIPInfoV4) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIPInfoV4) UnmarshalJSON(src []byte) error {
	v.isSet = true
