...
| v1.x-v7.x | [v3](https://docs.fingerprint.com/reference/v3/server-api) | Deprecated (security fixes only). See the [migration guide](https://docs.fingerprint.com/reference/go-server-sdk#migration-guide-for-go-sdk-v8). | To be decided | Maintained in the [old repository](https://github.com/fingerprintjs/fingerprint-pro-server-api-go-sdk) |
