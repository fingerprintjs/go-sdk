...
func TestSearchEvents(t *testing.T) {
	t.Run("Search with just limit", func(t *testing.T) {
		mockResponse := GetMockResponse[sdk.EventSearch]("../test/mocks/get_event_search_200.json")
		...
		assert.Equal(t, *eventSearch, mockResponse)
		assert.IsType(t, sdk.EventSearch{}, *eventSearch)
	})
